    ...
    constructor() {
      ...
      this.amrs = {
        'synq-amr-01': {
          ...
          missionId: null,
          pickup: '—',
          destination: 'P-23 (Pick Station)',
          eta: '00:16',
          currentNode: 'N_0_0',
          targetNode: 'N_2_2',
          route: ['N_0_0', 'N_0_1', 'N_1_1', 'N_2_2'],
          executedTrail: [],
          isSimulated: true,
          ip: '192.168.1.21',
          safetyState: {
        ...
        'synq-amr-03': {
          ...
          renderY: 0.0,
          heading: 90,
          velocity: { linear: 0.50, angular: 0.01, speed: 0.50 },
          speed: 0.50,
          battery: 38.0,
          cells: [3.28, 3.27, 3.28, 3.27],
          temperatureC: 32.4,
        ...
        'synq-amr-04': {
          id: 'synq-amr-04',
          name: 'AMR Unit 04',
          serial: 'SN-SYNQ-2026-004',
          status: 'Navigating',
          pose: { x: 5.0, y: 15.0, theta: 270 },
          x: 5.0,
          y: 15.0,
          renderX: 5.0,
          renderY: 15.0,
          heading: 270,
          velocity: { linear: 0.55, angular: 0.0, speed: 0.55 },
          speed: 0.55,
          battery: 71.0,
          cells: [3.35, 3.34, 3.35, 3.34],
          temperatureC: 29.5,
          payload: 'SCISSOR_LIFT',
          payloadPosition: 0.0,
          payloadCurrentA: 0.3,
          ...
          rosNode: '/synq_amr_04/lifecycle_amr (ACTIVE)',
          ekfCovariance: '0.014 m² (CONVERGED)',
          lastHeartbeat: Date.now()
        },
        'synq-amr-05': {
          id: 'synq-amr-05',
          name: 'AMR Unit 05',
          serial: 'SN-SYNQ-2026-005',
          status: 'Charging',
          pose: { x: 0.0, y: 15.0, theta: 0 },
          x: 0.0,
          y: 15.0,
          renderX: 0.0,
          renderY: 15.0,
          ...
          rosNode: '/synq_amr_05/lifecycle_amr (ACTIVE)',
          ekfCovariance: '0.009 m² (CONVERGED)',
          lastHeartbeat: Date.now()
        }
      };
